...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor>
{
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean>
    {
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            Call<LoginResponse> login = backendService.loginUser(new LoginModel(mEmail, mPassword));
            try
            {
                Response loginResponse = login.execute();
                if (loginResponse.isSuccessful())
                {
                    LoginResponse response = (LoginResponse) loginResponse.body();
                    if (response.success)
                    {

                    }
                    Log.d("resposne is ", response.toString());
                }
            }
            catch (IOException e)
            {
